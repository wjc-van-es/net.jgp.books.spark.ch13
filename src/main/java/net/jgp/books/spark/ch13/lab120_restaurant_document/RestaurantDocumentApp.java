...
//                .json("data/output/restaurants-fact-sheet.json");
    }
    ...
    public static Dataset<Row> nestedJoin(
        ...
        // groups by the columns on the left
        // then aggregates a list of the TEMP_COLUMN and put it as a single row value into the nestedCol
        // all grouped duplicated values of the leftColumns are put into the same single row
        resDf = resDf
                .groupBy(leftColumns)
                .agg(
